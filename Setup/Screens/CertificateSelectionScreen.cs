...
namespace CMS.Setup.Screens
{
    public partial class CertificateSelectionScreen : Form
    {
        ...
        private void btnViewCertificate_Click(object sender, EventArgs e)
        {
            ...
            {
                UI.ShowMessage(this, "Select a certificate in the list above, before clicking on the Select button.");
                return;
            }
            ...
            {
                UI.ShowMessage(this, "Perhaps certificate was deleted after display in this window?");
                RefreshCertificates();
            }
        }
        ...
        public void RefreshCertificates()
        {
            ...
            {
                UI.ShowMessage(this, "No valid certificates found. Close this window, import the SSL certificate into the Personal folder of your LocalMachine certificate store and try again.");
            }
        }
