<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="SiteACL.aspx.cs" Inherits="Corkscrew.ControlCenter.usergroups.SiteACL" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentAreaContent" runat="server">
    <p>
        Add or remove permissions for this user group. Using this page you can grant different levels of access to user groups to sites. Both Sites and User Groups must 
        already exist. 
    </p>
    <p>
        Group being permissioned:
